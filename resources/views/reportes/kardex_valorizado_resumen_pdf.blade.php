...
<body>
  <div class="container" style="font-family: 'Helvetica' !important">
    @include('reportes.partials.pdf.kardex_valorizado_resumen.header')
    @include('reportes.partials.pdf.kardex_valorizado_resumen.table')
  </div>
</body>
</html>
