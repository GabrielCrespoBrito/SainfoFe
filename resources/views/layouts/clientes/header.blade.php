...
<head>
  ...
  <title>@yield('title','SAINFO')</title>
...
{{--           <li class="dropdown tasks-menu">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"> {{ $cliente->PCNomb  }} </span>
            </a>
            <ul class="dropdown-menu">
              <!-- Menu Footer-->
              <li class="user-footer">
                <div class="">
                  <a href="{{ route('cliente_administracion.perfil') }}" class="btn btn-default btn-block btn-flat">Perfil</a>
                </div>
                <div>
