				...
				<div class="row" id="demo">
		          ...
		          <label>
					...
					<div class="col-md-6">
						<div class="radio">
		          <label>
		            <input type="radio" name="condicion_articulo" value="ventas" checked=""> Ventas por articulos </label>
		        </div>
					</div>
			  </div>
		  </fieldset>
		...
		<div class="cold-md-12">
			<fieldset class="fsStyle">			
				...
				<div class="row" id="demo">
		        	...
		        	<input type="text" placeholder="Codigo" name="codigo" class="form-control input-sm codigo"  value=""> 
		       	</div>
		      </div>

					<div class="col-md-9">
						<div class="form-group">
		          <input type="text" placeholder="Nombre del articulo" name="nombre" class="form-control input-sm nombre" value="">
		        </div>
					</div>	
