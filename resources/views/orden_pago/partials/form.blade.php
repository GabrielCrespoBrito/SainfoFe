  ...
  <div class="row">
      ...
      <div class="col-md-12 orden-resources">
        ...
        <div class="title estado">
          <a href="{{ route('suscripcion.ordenes.activar', $orden->id ) }}" class="btn btn-primary btn"> <span class="fa fa-check"></span>  Habilitar </a>
        </div>              
      </div>
      ...
      <div class="col-md-12 orden-resources">
        ...
        <div class="title estado">
          <a target="_blank" href="{{ route('suscripcion.ordenes.pdf', $orden->id ) }}" class="btn btn-primary btn"> <span class="fa fa-"></span>  Descargar Orden de Pago </a>
        </div>              
      </div>
