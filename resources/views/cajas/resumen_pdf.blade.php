<!DOCTYPE html>
  ...
  <body>
    <div class="container" style="font-family: 'Helvetica' !important">    
      @include('cajas.partials.reporte.header')

      @include('cajas.partials.reporte.ventas', [ 'nombre' => 'Detalle Ingresos' , 'n_soles' => 'CANINGS', 'n_dolar' => 'CANINGD', 'items' => $ingresos ])

      @include('cajas.partials.reporte.table', [ 'nombre' => 'Detalle Ingresos' , 'n_soles' => 'CANINGS', 'n_dolar' => 'CANINGD', 'items' => $ingresos ])

      @include('cajas.partials.reporte.table', [ 'nombre' => 'Detalle Egresos'  , 'n_soles' => 'CANEGRS', 'n_dolar' => 'CANEGRD', 'items'  => $egresos ])
    </div>
  </body>
</html>