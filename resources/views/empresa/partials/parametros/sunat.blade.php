@php
$route = $area_admin ? 
route('admin.empresa.update_sunat', $empresa->empcodi ) :
route('empresa.update_sunat', $empresa->empcodi )
    ...
    <div class="empresa-parametros">
      <div class="parametros_adicionales">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-6 no_p">
            <div class="input-group">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-6">
            <div class="input-group">
              <span class="input-group-addon c-input">Client ID </span>
              <input class="form-control input-sm" name="FE_CLIENT_ID" required type="password" value="{{ old('FE_CLIENT_ID', $empresa->FE_CLIENT_ID  ) }}">
            </div>
          </div>
          <div class="form-group col-md-6">
            <div class="input-group">
              <span class="input-group-addon c-input">Client Key</span>
              <input class="form-control input-sm" name="FE_CLIENT_KEY" required type="password" value="{{ old('FE_CLIENT_KEY', $empresa->FE_CLIENT_KEY  ) }}">
            </div>
          </div>
