  ...
  <div class="producto_asignacion">
    ...
    <div class="form-group col-md-3 no_pr">
      ...
      <div class="input-group">
        ...
        <span class="input-group-addon btn-search-product-nombre background-blue-sainfo" id="boton_buscar" style="cursor: pointer;" data-toggle="tooltip" title="Buscar producto"> <span class="fa fa-search"></span> </span>
    ...
    <div class="regular" style="display block">
      <div class="form-group col-xs-6  col-md-1 no_pr">
        <label>Unidad  <span title="Calcular Peso" class="calculate-peso hide"> <span class="fa fa-calculator"></span><span> </label>
      ...
      <div class="form-group col-xs-6 padding-xs col-md-1 no_pl">
        <label>Stock</label>
        {{-- inputs_producto --}}
        <input name="producto_stock" data-namedb="prosto1" data-name_item="prosto1" readonly="readonly" class="form-control input-sm inputs_producto">
      </div>
      ...
      <div class="form-group padding-xs hidden-xs col-xs-6 col-md-1 no_pl">
        <label>Dcto %</label>
        <input min="0" class="form-control input-sm inputs_producto" data-namedb="ProDcto1" data-name_item="DetDcto" name="producto_dct" data-default="0" type="text">
      </div>
      ...
      <div style="margin-top:10px" class="form-group padding-xs col-xs-12 no_pl">
        <a href="#" class="btn btn-block pull-right btn-xs hidden-md hidden-lg col-xs-12 col-sm-12 btn-primary item-accion crear"> <span class="fa fa-plus"></span> Agregar producto</a>
      </div>
