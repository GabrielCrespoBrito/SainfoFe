...
<div class="col-md-8 ventas">
  <div class="row">
    ...
    <div class="col-md-2 no_p col-sm-6  col-xs-6">
      <input type="text" value="{{ $fecha_desde }}" name="fecha_desde" class="form-control flat input-sm datepicker no_br text-center">
    </div>

    <div class="col-md-2 no_p col-sm-6  col-xs-6">
      <input type="text" value="{{ $fecha_hasta }}" name="fecha_hasta" class="form-control flat input-sm datepicker no_br text-center">
    </div>

    <div class="col-md-1 no_p">
      <button data-toggle="tooltip" title="Buscar documentos por estas fechas" class="btn btn-block buscar_factura_b btn-default btn-sm btn-flat"><span class="fa fa-calendar"></span> </button>
    </div>
    ...
    @include('components.specific.select_estado_almacen', ['size' => 'col-md-2 col-sm-6 col-xs-6 no_p'])
...
<div class="col-md-4 col-sm-12 col-xs-12 acciones-div ww no_p">
  ...
  <a href="{{ route('ventas.pendientes') }}" target="_blank" data-toggle="tooltip" title="Pendientes" class="btn btn-default btn-flat pull-right pendientes"> Pendientes </a>

  <a href="{{ route('ventas.nueva_factura') }}" data-toggle="tooltip" title="Nueva" class="btn btn-primary btn-flat pull-right crear-nuevo"> <span class="fa fa-plus"></span> Nueva </a>
