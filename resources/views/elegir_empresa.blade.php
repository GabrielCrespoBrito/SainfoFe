...
<body class="hold-transition login-page" style="background: #ccc url('images/background.jpg') no-repeat;">
    <div class="login-box">
        ...
        <div class="login-box-body" style="overflow: hidden;">
            <p class="login-box-msg">Bienvenido <span class="user_elegir_empresa">{{ auth()->user()->usunomb }}</span>,
            ...
            <form action="{{ route('empresa.seleccionada') }}" id="elegirEmpresaPeriodo" method="POST">
                ...
                <div class="form-group has-feedback {{ $errors->has('periodo') ? 'has-error' : '' }}">
                    ...
                    <select name="periodo" class="form-control" required>
                        ...
                        <option {{ $periodo->Pan_cAnio == date('Y') ? 'selected=selected' : '' }}
                            value="{{ $periodo->Pan_cAnio }}"> {{ $periodo->Pan_cAnio }} </option>
                        @endforeach
                    </select>
                ...
                <div class="row" style="margin-bottom: 20px">
                    <div class="col-xs-6">
                        <button type="submit" style="margin-top:0"
                            class="btn btn-primary btn-block btn-group btn-flat"> <span class="fa fa-check"></span>
                            Ingresar</button>
                    </div>
                    ...
                    <div class="col-xs-6">
                        <a href="#"
                            ...
                            class="btn btn-danger btn-group btn-block btn-flat"> <span class="fa fa-power-off"></span>
                            Salir </a>
                    </div>
