  ...
  <div class="row">	
    ...
    <div class="form-group col-md-3 ">  
      <label> Tipo de impresión  
        <a href="#" class="btn btn-xs btn-default pull-right ejemplo-imprecion a4">ticket</a>
        <a href="#" class="btn btn-xs btn-default pull-right ejemplo-imprecion a4">a5</a>
        <a href="#" class="btn btn-xs btn-default pull-right ejemplo-imprecion a4">a4</a> 
      </label>
      
      <select class="form-control input-sm" name="formato_hoja" type="text" value="">     
        <option {{ $empresa->isA42() ? 'selected=selected' : ''  }} value="1"> A4 </option>
        <option {{ $empresa->isA5() ? 'selected=selected' : ''  }} value="4"> A5 </option>
