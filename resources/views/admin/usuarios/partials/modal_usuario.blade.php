...
@php
  ...
  $routeStore = $isAdmin ? route('admin.usuarios.store') : route('usuarios.store.owner');
  $routeUpdate = $isAdmin ? route('admin.usuarios.update') : route('usuarios.update.owner');
@endphp
<div class="modal fade" id="ModalNuevoUsuario" 
data-urlstore="{{ $routeStore }}"
data-urlupdate="{{ $routeUpdate }}">
