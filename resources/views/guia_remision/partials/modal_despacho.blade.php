          ...
          <div class="row">
                ...
                <div class="input-group">
                  ...
                  <div class="fixed_position">
                    ...
                    <select id="destinatario" data-text="{{ $destinatario->getNombre() }}"
                      ...
                      data-url="{{ route('clientes.ventas.search') }}" class="form-control input-sm select2"
            ...
            <div class="form-group col-md-12">
              <div class="input-group">
                ...
                <input class="form-control input-sm" name="direccion_partida" type="text"
                  value="{{ $guia->getDireccionPartida() }}">
              </div>
            </div>
            ...
            <div class="form-group col-md-12">
              <div class="input-group">
                ...
                <div class="fixed_position">
                  @php
                    $ubigeo_partida = $guia->getUbigeoPartida();
                    $ubinomb = is_null($ubigeo_partida)
                        ? ''
                        : $ubigeo_partida->ubicodi . ' - ' . $ubigeo_partida->ubinomb;
                    $ubicodi = is_null($ubigeo_partida) ? '' : $ubigeo_partida->ubicodi;
                  @endphp
                  <select id="ubigeo_partida" data-text="{{ $ubinomb }}" data-id="{{ $ubicodi }}"
                    name="ubigeo_partida" data-url="{{ route('clientes.ubigeosearch') }}"
            ...
            <div class="form-group col-md-12">
              <div class="input-group">
                ...
                <input class="form-control input-sm" name="direccion_llegada" type="text"
                  value="{{ $guia->getDireccionLlegada() }}">
              </div>
            </div>
            <div class="form-group col-md-12">
              <div class="input-group">
                ...
                <div class="fixed_position">
                  @php
                    $ubigeo_llegada = $guia->getUbigeoLlegada();
                    $ubinomb = is_null($ubigeo_llegada)
                        ? ''
                        : $ubigeo_llegada->ubicodi . ' - ' . $ubigeo_llegada->ubinomb;
                    $ubicodi = is_null($ubigeo_llegada) ? '' : $ubigeo_llegada->ubicodi;
                  @endphp
                  <select id="ubigeo" data-text="{{ $ubinomb }}" data-id="{{ $ubicodi }}"
                    name="ubigeo_llegada" data-url="{{ route('clientes.ubigeosearch') }}"
                    class="form-control input-sm select2"" style="display:none;position:absolute;">
                  </select>
                </div>
              </div>
                  ...
                  <select class="form-control input-sm" data-old_option="" name="motivo_traslado">
                    @foreach (cacheHelper('motivotraslado.all') as $motivo)
                      <option data-type="{{ (int) $motivo->isProveedor() }}"
                        {{ $motivo->MotCodi == $guia->motcodi ? 'selected' : '' }} value="{{ $motivo->MotCodi }}">
                        {{ $motivo->MotNomb }} </option>
                    @endforeach
                  </select>
                </div>
              </div>
              ...
              <div class="form-group col-md-12">
                <div class="input-group">
                  ...
                  <select class="form-control input-sm" name="modalidad_traslado">
                    <option value="01" {{ $mod_traslado == '01' ? 'selected=selected' : '' }}> Transporte Publico
                    </option>
                    <option value="02" {{ $mod_traslado == '02' ? 'selected=selected' : '' }}> Transporte Privado
                    </option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-md-12 campos-export">
                ...
                <div class="form-group col-md-6 no-p">
                  <div class="input-group">
                    ...
                    <select class="form-control input-sm" name="tipo_export">
                      <option value="50" {{ $exportData->tipo_export == '50' ? 'selected=selected' : '' }}>
                        Declaración
                        Aduanera de Mercancías remitente, transportista </option>
                      <option value="52" {{ $exportData->tipo_export == '52' ? 'selected=selected' : '' }}>
                        Declaración
                ...
                <div class="form-group col-md-6">
                  <div class="input-group">
                    ...
                    <input class="form-control input-sm text-uppercase" name="export_doc_num" type="text"
                      value="{{ $exportData->documento_id }}">
                  </div>
                </div>
...
--}}
            ...
            <div data-field-traslado="02" class="mod-campo form-group col-md-12">
              <div class="input-group">
                ...
                @endphp
                <select data-event="select2" placeholder="Elegir transportista" data-minimuminputlength="0"
                  class="form-control input-sm select2" data-url="{{ route('transportista.search') }}"
                  data-text="{{ $transportistaNombre }}" data-id="{{ $transportistaId }}" name="transportista"
                  style="display:none;position:absolute">
                </select>
                <span class="input-group-addon" style="margin-bottom: 0">
                  <a href="{{ route('transportista.create') }}" target="_blank" class="" id="notCredito">
            ...
            <div data-field-traslado="02" class="mod-campo form-group col-md-12">
              <div class="input-group">
                ...
                @endphp
                <select data-event="select2" placeholder="Elegir Elegir Vehiculo" data-minimuminputlength="0"
                  class="form-control input-sm select2" data-url="{{ route('vehiculo.search') }}"
                  data-text="{{ $vehiculoNombre }}" data-id="{{ $vehiculoId }}" name="placa"
                  style="display:none;position:absolute">
                </select>
                <span class="input-group-addon" style="margin-bottom: 0">
                  <a href="{{ route('vehiculo.create') }}" target="_blank" class="" id="notCredito">
                    <span class="fa fa-plus"></span>
                  </a>
                </span>
              </div>
            ...
            <div data-field-traslado="01" class="mod-campo form-group col-md-12">
              <div class="input-group">
                ...
                @endphp
                <select data-event="select2" placeholder="Elegir Empresa de transporte" data-minimuminputlength="0"
                  class="form-control input-sm select2" data-url="{{ route('empresa_transporte.search') }}"
                  data-text="{{ $empresaTransporteNombre }}" data-id="{{ $empresaTransporteId }}" name="empresa"
                  style="display:none;position:absolute">
                </select>
                <span class="input-group-addon" style="margin-bottom: 0">
                  <a href="{{ route('empresa_transporte.create') }}" target="_blank" class=""
                    id="notCredito">
                    <span class="fa fa-plus"></span>
                  </a>
                </span>
            ...
            <div class="form-group col-md-6">
              <div class="input-group">
                ...
                <input class="form-control input-sm" name="documento_referencia" disabled type="text"
                  value="{{ $guia->docrefe }}">
              </div>
            </div>
            <div class="form-group col-md-6">
                  ...
                  <select name="serie_documento" class="form-control input-sm">
                    @foreach ($tipos_documentos as $tipo_documento)
                      <option {{ $loop->first ? 'selected' : '' }}
                        data-codigo="{{ $tipo_documento['nuevo_codigo'] }}" value="{{ $tipo_documento['id'] }}">
