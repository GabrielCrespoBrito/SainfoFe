                ...
                <form id="form_despacho">
                    <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <div class="input-group">
                                    ...
                                    <select class="form-control input-sm" name="modalidad_traslado">
                                        <option value="01" {{ $mod_traslado == '01' ? 'selected=selected' : '' }}>
                                            Transporte Publico
                                        </option>
                                        <option value="02" {{ $mod_traslado == '02' ? 'selected=selected' : '' }}>
                                            Transporte Privado
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6 no-p">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control input-sm" name="tipo_export">
                                            <option value="50"
                                                {{ $exportData->tipo_export == '50' ? 'selected=selected' : '' }}>
                                                Declaración
                                                Aduanera de Mercancías remitente, transportista </option>
                                            <option value="52"
                                                {{ $exportData->tipo_export == '52' ? 'selected=selected' : '' }}>
                                                Declaración
                        ...
                        <div data-field-traslado="02" class="mod-campo form-group col-md-12">
                            <div class="input-group">
                                <span class="input-group-addon"><a href="{{ route('transportista.index') }}"
                                        target="_blank">Transportista</a> <span class="fa fa-eye"></span></span>
                                @php
                        ...
                        <div data-field-traslado="02" class="mod-campo form-group col-md-12">
                            <div class="input-group">
                                <span class="input-group-addon"><a href="{{ route('vehiculo.index') }}"
                                        target="_blank">Vehiculo </a> <span class="fa fa-eye"></span></span>
                                @php
                        ...
                        <div data-field-traslado="01" class="mod-campo form-group col-md-12">
                            <div class="input-group">
                                <span class="input-group-addon"><a href="{{ route('empresa_transporte.index') }}"
                                        target="_blank">Empresa de Transporte </a> <span
