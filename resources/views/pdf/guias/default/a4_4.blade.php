...
'class_name' => 'col-10 mt-x5 border-width-2 border-color-blue-light border-style-solid border-radius-5',
'nombre_campo_class' => 'bold text-uppercase pl-x3',
'descripcion_campo_class' => 'text-uppercase italic',
])

@endif
<!-- border-width-1 table-with-border border-radius-5 -->
...
'thead_class' => 'bg-white c-black border-bottom-style-solid border-left-style-solid border-width-2 pl-x3 pt-x3 pb-x3 text-uppercase text-left border-color-blue-light' ,
'tbody_class' => 'border-bottom-style-dotted  border-color-blue-light border-right-style-solid border-width-2 pl-x3 pt-x3 pb-x3 text-left',
'class_codigo' => 'border-left-style-solid border-color-blue-light border-width-2',
])

@include('pdf.guias.partials.peso_total', [
'class_name' => 'col-12 mt-x20 border-top-0 border-style-solid border-color-blue-light border-width-2 ',
...
'class_name' => 'mt-x4',
'table_class' => ' border-top-style-solid border-bottom-style-solid border-left-style-solid pb-x10 pt-x10 border-color-blue-light border-width-2',
