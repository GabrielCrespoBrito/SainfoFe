...
<div class="row">
  @include('pdf.guias.partials.info_empresa', [ 'class_name' => 'col-12',
...
<div class="row">
  ...
  @if($isGuiaTransportista)
    ...
    @include('pdf.guias.partials.info_cliente', [
    'class_name' => 'col-12 border-width-1 mt-x3 mb-x2 pl-x2 border-style-solid border-radius-5',
...
'class_name' => 'col-10 mt-x2 mb-x2 border-style-solid border-width-1 border-radius-5',
...
@include('pdf.guias.partials.info_documento1', [
  'class_name' => 'text-top border-style-right-solid mt-x5',
  'class_name_table' => 'border-style-solid border-color-black border-width-1',
])
