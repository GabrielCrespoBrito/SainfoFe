...
<div style="overflow:hidden" class="info_cliente {{ $class_name }}">
    ...
    <div class="col-3">
        <div class="fecha_emision_div_class">
            <span class="fecha_emision_campo_class">Forma de Pago: </span>
            <span class="fecha_emision_text bold text-right pull-right pl-x3"> {{ optional($forma_pago)->connomb . return_strs_if($medio_pago_nombre, '-' , $medio_pago_nombre)  }} </span>
        </div>
        <div class="fecha_emision_div_class">
            <span class="fecha_emision_campo_class">Moneda: </span>
            <span class="fecha_emision_text bold text-right pull-right pl-x3"> {{ $moneda_abreviatura }} </span>
        </div>
    </div>
