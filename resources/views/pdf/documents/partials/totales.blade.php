...
<div class="{{ $class_name }}" style="{{ $style }}">
  ...
  <table width="100%">
    ...
    <tr>
      ...
      <td class="total_value {{ $total_value_class }}"> <span class="moneda_abbr">{{ $moneda_abreviatura }} </span>  {{ fixedValue( $gravadas )}} </td>
    </tr>
    @endif
    ...
    <tr>
      ...
      <td class="total_value {{ $total_value_class }}"> <span class="moneda_abbr">{{ $moneda_abreviatura }} </span> {{ fixedValue($exonerada) }}</td>
    </tr>
    @endif
    ...
    <tr>
      ...
      <td class="total_value {{ $total_value_class }}">  <span class="moneda_abbr">{{ $moneda_abreviatura }} </span> {{ fixedValue($inafecta) }} </td>
    </tr>
    @endif
    ...
    <tr>
      ...
      <td class="total_value {{ $total_value_class }}">  <span class="moneda_abbr">{{ $moneda_abreviatura }} </span> {{ fixedValue($gratuita) }} </td>
    </tr>
    @endif
    ...
    <tr>
      ...
      <td class="total_value {{ $total_value_class }}"> <span class="moneda_abbr">{{ $moneda_abreviatura }} </span> {{ fixedValue($totalDcto) }}</td>
    </tr>
    @endif
    ...
    <tr>
      ...
      <td class="total_value {{ $total_value_class }}"> <span class="moneda_abbr">{{ $moneda_abreviatura }} </span> {{ fixedValue($icbper) }}</td>
    </tr>
    @endif
   ...
   <tr>
      ...
      <td class="total_value {{ $total_value_class }}"> <span class="moneda_abbr">{{ $moneda_abreviatura }} </span> {{ fixedValue($isc) }}</td>
    </tr>
    @endif
    ...
    <tr>
      ...
      <td class="total_value {{ $total_value_class }}"> <span class="moneda_abbr">{{ $moneda_abreviatura }} </span> {{ fixedValue($igv ) }}</td>
    </tr>
    @endif
    ...
    <tr>
      ...
      <td class="total_value {{ $total_value_class }}"> <span class="moneda_abbr">{{ $moneda_abreviatura }} </span> {{ fixedValue( $venta2->percepcionMonto() ) }}</td>
    </tr>
    @endif
    ...
    <tr>
      ...
      <td class="total_value {{ $total_value_class }}"> <span class="moneda_abbr">{{ $moneda_abreviatura }} </span> {{ fixedValue($anticipo) }}</td>
    </tr>
    @endif
    ...
    <tr>
      ...
      <td class="total_value {{ $total_value_class }}"> <span class="moneda_abbr">{{ $moneda_abreviatura }} </span> {{ fixedValue( $total ) }}</td>
    </tr>
    @endif
