@component('pdf.documents.partials.content', [
    ...
    @slot('content')
            ...
            @slot('content')
                <div class="row">
                    ...
                    @include('pdf.documents.partials.id', [
                        'class_name' =>
                            'col-3 border-style-solid border-radius-5 border-width-1 border-color-blue-light m-0 h4 yellow text-center',
                        'ruc' => $empresa['EmpLin1'],
                ...
                <div class="row">
                    @include('pdf.documents.partials.info_cliente_adicional', [
                        'class_name' =>
                            'col-12 mt-x5 mb-x5 pt-x5 pl-x5 pr-x5 pb-x5 border-color-blue-light border-width-1 border-style-solid border-radius-5',
                ...
                @include('pdf.documents.partials.observacion', [
                    'class_name' => 'col-12',
                    'class_name' =>
                        'border-width-1 mb-x4 pt-x5 pl-x5 pr-x5 pb-x5 border-width-1 border-style-solid border-color-blue-light border-radius-5',
        ...
        @include('pdf.documents.partials.table', [
            ...
            'thead_class' =>
                'font-size-9 pt-x2 pl-x3 pb-x2 border-right-style-solid border-bottom-style-solid border-width-1 bg-white c-black border-color-blue-light',
            'thead_importe_class' => 'border-right-0',
            'tbody_class' =>
                'pt-x2 pl-x3 pb-x2 border-color-blue-light border-bottom-style-dashed border-right-style-solid border-width-1 border-color-blue-light font-size-8 border-color-blue-light',
            'class_precio_unit' =>
                'text-right pr-x3 border-right-style-solid border-width-1 border-color-blue-light',
            'class_importe' => 'text-right pr-x3 border-right-0',
            'class_cant' =>
                'text-right pl-x1 pr-x8 pr-x3 border-right-style-solid border-width-1 border-color-blue-light',
            ...
            'class_descripcion' =>
                'border-right-style-solid text-align-center border-width-1 border-color-blue-light',
        ])
            ...
            @slot('content')
                ...
                <div class="row position-relative">
                    ...
                    @include('pdf.documents.partials.info_adicional', [
                        ...
                        'info_adicional_class' => $venta2->isNotaVenta()
                            ? 'col-10 pl-x5 border-right-style-solid border-width-1 border-color-blue-light'
                            : 'col-7 border-right-style-solid border-width-1 border-color-blue-light',
                    ...
                    @include('pdf.documents.partials.totales', [
                        ...
                        'class_name_table' =>
                            'border-width-1 table-with-border border-radius-5 border-color-blue-light ',
                ...
                <div class="row">
                    ...
                    @include('pdf.documents.partials.pagos', [
                        'class_name' =>
                            'col-5 border-right-style-solid border-top-style-solid border-width-1 border-color-blue-light ',
                        'class_name_table' => 'border-width-1 border-color-blue-light table-with-border',
                        'titulo_div_class' =>
                            'bold pl-x3 text-uppercase bold pl-x3 mb-x3 border-bottom-style-solid border-width-1 border-color-blue-light ',
                    ...
                    @include('pdf.documents.partials.cuentas', [
                        ...
                        'class_name_table' => '',
                        'titulo_div_class' =>
                            'bold pl-x3 mb-x3 border-bottom-style-solid border-width-1 border-color-blue-light ',
