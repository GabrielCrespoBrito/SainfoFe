...
{{-- Start --}}
     ...
     {{--  --}}
        ...
        <div class="col-10 mt-x5 letter-spacing-1px pl-x10 pr-x10 pt-x3 pb-x3 border-color-black border-radius-10 border-style-solid border-width-2 overflow-hidden">
