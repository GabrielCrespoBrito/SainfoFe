@component('pdf.documents.partials.content', [
    ...
    @slot('content')
            ...
            @slot('content')
                ...
                <div class="row">
                    ...
                    @include('pdf.documents.partials.info_cliente_adicional2', [
                        'class_name' =>
                            'col-12 pl-x5 pt-x5 border-width-1 border-color-blue-light mt-x5 pl-x2 border-style-solid',
                ...
                @include('pdf.documents.partials.observacion', [
                    'class_name' =>
                        'mb-x4 pl-x2 border-color-blue-light border-style-solid border-width-1 border-top-0',
        ...
        @include('pdf.documents.partials.table_cot1', [
            ...
            'thead_class' =>
                'bg-blue-light c-white border-right-style-solid border-color-blue-light border-bottom-style-solid border-width-1 pt-x2 pb-x2 border-color-black',
            'tbody_class' =>
                'td-right-solid-border pt-x2 pb-x2 border-right-style-solid border-bottom-style-dashed pb-x2 vertical-align-top border-color-blue-light  border-width-1 font-size-9',
            'tbody_td_class' => 'border-bottom-style-dashed border-width-1 border-color-blue-light',
            'class_precio_unit' =>
