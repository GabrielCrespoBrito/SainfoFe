...
<div class="row">
  ...
  'ruc' => $empresa['EmpLin1'],
  'class_nombre' => 'bold pt-x5 pb-x5 c-vinotinto',
...
'thead_class' => 'font-size-9 pt-x2 pl-x3 pb-x2 border-right-style-solid border-bottom-style-solid border-width-1 bg-cccccc c-black',
...
'class_descripcion' => 'border-right-style-solid border-width-1',
    ...
    <div class="row">
      ...
      'cuenta_text_class' => 'pl-x3 c-vinotinto',
