...
'class_name' => 'col-12 border-style-solid border-width-1 border-color-blue-light border-bottom-0' . $footerBreak ? '' : 'container-table-height',
...
'class_descripcion' => 'border-right-style-solid text-align-center border-width-2 border-color-blue-light',
    ...
    'class_name' => "mt-x4 border-color-blue-light border-style-solid footer-full-table border-width-2 position-initial"
    ])
