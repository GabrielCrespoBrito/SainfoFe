...
@if(($cant_items >= 24 && $cant_items <= 45) || ($cant_items>= 88 && $cant_items <= 105) || ($cant_items>= 131))
    @php
...
@endif
    ...
    <div class="row">
      ...
      'class_name_table' => 'border-width-1 table-with-border border-radius-5',
      'titulo_div_class' => 'bold pl-x3 text-uppercase pl-x3 mb-x3 border-bottom-style-solid border-width-1',
