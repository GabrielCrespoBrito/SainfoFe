@component('pdf.documents.partials.content', [
    ...
    @slot('content')
            ...
            @slot('content')
                <div class="row">
                    ...
                    @include('pdf.documents.partials.id', [
                        'class_name' =>
                            'col-3 border-style-solid border-radius-5 border-width-1 m-0 h4  text-center',
                        'ruc' => $empresa['EmpLin1'],
                ...
                <div class="row">
                    ...
                    @include('pdf.documents.partials.info_cliente', [
                        'class_name' =>
                            'col-12 border-width-1 mt-x5 mb-x5 pl-x2 border-style-solid border-radius-5',
        ...
        @include('pdf.documents.partials.table', [
            ...
            'tbody_class' =>
                'pt-x2 pl-x3 pb-x2 border-bottom-width-1 border-bottom-color-gray border-bottom-style-dotted border-right-style-solid border-width-1 font-size-8',
        ...
        @component('pdf.documents.partials.footer', [
            'class_name' => "bg-white mt-x4 border-style-solid border-width-1 {$classFooter} ",
        ])
            @slot('content')
                <div class="row">
                ...
                <div class="row position-relative">
                    ...
                    @include('pdf.documents.partials.info_adicional', [
                        ...
                        'info_adicional_class' => $venta2->isNotaVenta()
                            ? 'col-10 pl-x5 border-right-style-solid border-width-1'
                            : 'col-7 border-right-style-solid border-width-1',
                ...
                <div class="row">
                    ...
                    @include('pdf.documents.partials.pagos', [
                        ...
                        'class_name_table' => 'border-width-1 table-with-border border-radius-5',
                        'titulo_div_class' =>
                            'bold pl-x3 text-uppercase pl-x3 mb-x3 border-bottom-style-solid border-width-1',
                    ...
                    @include('pdf.documents.partials.cuentas', [
                        ...
                        'cuenta_cuenta_text_class' => 'bold  font-size-8',
                    ])
