        ...
        <div class="producto_asignacion">
            ...
            <div class="form-group col-md-3 no_pr">
                <label class="label_producto">Producto
                    <span class="label-incluye-igv"><label id="incluye_igv"> Incl. IGV <input type="checkbox"
                                value="1" data-name_item="incluye_igv" data-namedb="incluye_igv"
                                name="incluye_igv"> </label></span>
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-addon" id="boton_buscar" style="cursor: pointer;"> <span
            ...
            <div class="form-group padding-xs col-md-1 no_pl">
                ...
                <input class="form-control input-sm inputs_producto" data-name_item="DetPrec" name="producto_precio"
                    min="0" data-default="0" value="0" type="text">
            </div>

            <div class="form-group padding-xs col-md-1 no_pl">
                <label>Dcto</label>
                <input min="0" class="form-control input-sm inputs_producto" data-namedb="ProDcto1"
                    data-name_item="DetDcto" name="producto_dct" data-default="0" value="0" type="text">
            </div>
            ...
            <div class="form-group padding-xs col-md-1 no_pl">
                ...
                <select name="producto_igv" data-namedb="BaseIGV" data-default="GRAVADA" data-name_item="DetBase"
                    ...
                    <option data-porc="1.18" data-value="18" data-default="selected"selected="selected" value="GRAVADA">
                        GRAVADA</option>
