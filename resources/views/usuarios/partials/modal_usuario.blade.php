                ...
                <form id="form-usuario" onsubmit="return false;">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8">
                            <label> Nombre Completo * vvvv</label>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <span class="cursor-pointer input-group-addon show-hide-password"><i
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                @foreach ($roles as $role)
                                    <div class="checkbox">
                                        <label>
                                            <input value="{{ $role->id }}" data-name="{{ $role->name }}"
                                                class="roles" name="roles[]" type="checkbox">
                                            {{ ucfirst($role->name) }}
                                        </label>
                                    </div>
                                @endforeach
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <a class="btn btn-primary btn-flat send_user_info"> <span class="fa fa-save"></span>
                                Guardar</a>
                        </div>
                    </div>
