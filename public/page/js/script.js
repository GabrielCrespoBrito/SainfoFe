...
(function () {
  ...
  $(function () {
    ...
    $(".box-modules .box-icon-2").on('click', function () {

      let classActive = 'active';

      let $this = $(this);

      if ($this.is(".".concat(classActive))) {
        return false;
      }

      let id_target = $this.data('target');
      let $modulos_btns = $(".box-modules .box-icon-2");
      let $modulos_divs = $(".section-modulo");


      // Poner clase de activo al boton del modulo actual
      $modulos_btns.removeClass(classActive);
      $this.addClass(classActive);


      console.log(id_target, $modulos_divs.length);

      // Mostrar 
      $modulos_divs.hide();
      $modulos_divs.filter(id_target).show(100);
  ...
  function imgSliderCss($ele) {

    const width = window.innerWidth;

    const urlMobil = $ele.attr('data-slider-bg-mobil');
    ...
    console.log( width, isMobile, cssStyles )
