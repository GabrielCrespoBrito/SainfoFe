...
return [
    ...
    'db' => [
        ...
        'password-generator' => App\Helpers\TenantHelper\PasswordTenantCustom::class,
        ...
        // 'tenant-seed-class' => 'app\seeds\TenancySeeder.php',
         ...
         */
        'tenant-database-user-privileges' => true,
