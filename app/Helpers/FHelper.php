  ...
  */
  ...
  public function setAllPaths()
  {
    $this->paths = [
      ...
      self::FTP => [
        'data'  => $this->getPathFTP('XMLData'),
        'envio' => $this->getPathFTP('XMLEnvio'),
        'cdr'   => $this->getPathFTP('XMLCDR'),
        'cert'  => $this->getPathFTP('XMLCert'),
        'pdf'   => $this->getPathFTP('XMLPDF'),
        'img'   => $this->getPathFTP('images'),
      ],
  ...
  public function existsInFtp($sitio, $name)
  {
    return $this->exists_ftp($this->getPath(self::FTP, $sitio, $name));
  }
