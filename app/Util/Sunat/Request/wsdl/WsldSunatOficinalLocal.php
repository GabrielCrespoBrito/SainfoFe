...
class WsldSunatOficialLocal implements WsldInterface
{
  ...
  const BILLCONSULT_PRODUCTION = "https://www.sunat.gob.pe/ol-it-wsconscpegem/billConsultService?wsdl";
  ...
  {
    throw new Exception("Sunat No tiene servicios para el ambiente de desarrollo", 1);
  }
}
