...
class CajaEgresoStoreRequest extends FormRequest
{
	...
	public function withValidator($validator)
  {
		...
		if( !$validator->fails()){
			...
			$validator->after(function($validator) use($caja_current) {
              ...
              if( $caja_current->CueCodi == $banco->CueCodi ){
                $validator->errors()->add('banco_id', 'No es posible, Transferir a la misma cuenta');
                return;
              }
